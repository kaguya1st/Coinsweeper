...
class Coinsweeper {
  ...
  promptGameConfig() {
    console.log("Masukan angka untuk konfigurasi BOT :");
    console.log("Note: Kisaran default untuk waktu permainan adalah 90 sampai 300 seconds.");
    console.log("Note: Kisaran Scor yg di peroleh  600 Sampai 900 points.");

    const minGameTime = parseInt(
      prompt("Waktu Bermain game(per detik, default 90): ") || "90"
    );
    const maxGameTime = parseInt(
      prompt("Maxsimal waktu bermain(per detik, default 300): ") || "300"
    );
    const minScore = parseInt(prompt("Minimum score yg di dapatkan (default 600): ") || "600");
    const maxScore = parseInt(prompt("Maximum score yg di dapatkan (default 900): ") || "900");
